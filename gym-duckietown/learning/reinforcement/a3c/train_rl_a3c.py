...
# Duckietown Specific
from learning.reinforcement.a3c import a3c_model as a3c
from learning.reinforcement.a3c import CustomOptimizer
...
if __name__ == '__main__':
    ...
    parser.add_argument("--max_steps", default=10000000, type=int)  # Max time steps to run environment for
    ...
    parser.add_argument("--save_frequency", default=100000, type=int)  # Whether or not models are saved
    parser.add_argument('--save_on_interrupt', default=True)
    parser.add_argument('--model_dir', type=str, default='reinforcement/a3c/models')  # Name of the directory where the models are saved
